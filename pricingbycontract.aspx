...
<html>
	...
	<body code="Pricing">
		...
		<div class="AdditionCost append" >
			<table class="addition">
				<tr>
					...
					<td class="td3">
						<div class="unit"><input type="text" value="" onkeyup="this.value=(this.value.match(/\d+(\.\d{0,2})?/)||[''])[0]" class="AdditionPrice"><p>元</p></div>
					</td>
				</tr>
				<tr>
					<td class="td1">说明：</td>
		...
		<div class="continue">
		<div class="continuemark"><img src="img/addition.png"><span><a href="javascript:void(0)" onclick="Continue()">继继续补充报价</a></span></div>
		</div>
		...
		<div class="accord">
			<table>	
				<tr>
					<td colspan="4">
						<div class="tijiao" onclick="AdditionCost()" >提交报价</div>
					</td>
				</tr>
			</table>
		</div>
