...
<html>
	...
	<body code="information">
		...
		<div id="main">
			<div class="inp"> 
				<input class="shuru uname" type="text" placeholder="用户名称"> 
				<input class="shuru uphone" type="text" placeholder="用户电话">
				<div class="subbtn1" onclick="InforSave()">保存</div>
			</div>
		</div>
	...
	<script type="text/javascript">
		seajs.use('/assets/NSF/js/NSF.System.Data.js', function() {
			 ...
			 $('input.uname').val(_data.name);
			 $('input.uphone').val(_data.phone);
		});
	</script>
</html>